...
const TOPICS = [
  ...
  { t: 'VM Scale Sets', tp: 'Conjuntos de Dimensionamento de VMs', cat: 'compute', icon: 'scale', level: 'intermediate', time: 8,
    ...
    dp: 'Executa e dimensiona automaticamente VMs idênticas atrás de um balanceador de carga para lidar com picos de tráfego.' },
  { t: 'Availability Sets & Zones', tp: 'Conjuntos e Zonas de Disponibilidade', cat: 'compute', icon: 'cloud', level: 'intermediate', time: 7,
    ...
    dp: 'Mantém as cargas de trabalho resilientes distribuindo VMs por domínios de falha e datacenters fisicamente separados.' },
  { t: 'Managed Disks', tp: 'Discos Geridos', cat: 'storage', icon: 'disk', level: 'beginner', time: 6,
    ...
    dp: 'Compreende discos de SO vs dados, escalões Standard HDD, SSD e Premium, snapshots e encriptação.' },
  { t: 'Virtual Network (VNet)', tp: 'Rede Virtual (VNet)', cat: 'networking', icon: 'network', level: 'beginner', time: 10,
    ...
    dp: 'A base das redes no Azure — sub-redes, espaços de endereços, peering e conectividade privada.', featured: true },
  { t: 'Network Security Groups', tp: 'Grupos de Segurança de Rede', cat: 'security', icon: 'firewall', level: 'beginner', time: 7,
    ...
    dp: 'Filtra o tráfego de entrada e saída das tuas sub-redes e NICs com regras simples e priorizadas.' },
  { t: 'Azure Load Balancer', tp: 'Balanceador de Carga do Azure', cat: 'networking', icon: 'balance', level: 'intermediate', time: 8,
    ...
    dp: 'Distribui o tráfego por VMs saudáveis na camada 4 para alta disponibilidade e escala.' },
  { t: 'Application Gateway', tp: 'Application Gateway', cat: 'networking', icon: 'gateway', level: 'advanced', time: 9,
    ...
    dp: 'Balanceamento de carga na camada 7 com SSL offload, encaminhamento por URL e Web Application Firewall integrada.' },
  { t: 'VPN & ExpressRoute', tp: 'VPN e ExpressRoute', cat: 'networking', icon: 'vpn', level: 'advanced', time: 11,
    ...
    dp: 'Liga redes locais ao Azure de forma segura através da internet ou de um circuito privado.' },
  { t: 'Azure DNS', tp: 'Azure DNS', cat: 'networking', icon: 'dns', level: 'beginner', time: 5,
    ...
    dp: 'Aloja os teus domínios no Azure e resolve nomes para cargas de trabalho públicas e privadas.' },
  { t: 'Azure Firewall', tp: 'Azure Firewall', cat: 'security', icon: 'firewall', level: 'advanced', time: 9,
    ...
    dp: 'Uma firewall de rede gerida e com estado, com inteligência de ameaças para proteger as tuas VNets.' },
  { t: 'Azure Key Vault', tp: 'Azure Key Vault', cat: 'security', icon: 'key', level: 'intermediate', time: 7,
    ...
    dp: 'Guarda segredos, chaves e certificados em segurança, mantendo-os fora do código e das configurações.' },
  { t: 'Blob & Disk Storage', tp: 'Armazenamento Blob e de Discos', cat: 'storage', icon: 'storage', level: 'beginner', time: 8,
    ...
    dp: 'Armazena dados não estruturados e discos de VMs. Aprende escalões de acesso, redundância e regras de ciclo de vida.' },
  { t: 'Resource Groups', tp: 'Grupos de Recursos', cat: 'mgmt', icon: 'group', level: 'beginner', time: 5,
    ...
    dp: 'Organiza, implementa e gere recursos relacionados como uma única unidade lógica com ciclo de vida partilhado.' },
  { t: 'ARM & Bicep Templates', tp: 'Modelos ARM e Bicep', cat: 'mgmt', icon: 'template', level: 'intermediate', time: 10,
    ...
    dp: 'Define a tua infraestrutura como código para implementações repetíveis, revisíveis e fiáveis.' },
  { t: 'Azure Monitor', tp: 'Azure Monitor', cat: 'mgmt', icon: 'monitor', level: 'intermediate', time: 8,
    ...
    dp: 'Recolhe métricas e registos, cria dashboards e dispara alertas para manter o teu sistema saudável.' },
];
